...
## Top Left: Global Active Power by Day
plot(wkday_h_power, as.numeric(subh_power$Global_active_power), type = "l",
     xlab = " ", ylab = "Global Active Power")


## Top Right: Voltage by Datetime
plot(wkday_h_power, as.numeric(subh_power$Voltage), type = "l",
     xlab = "datetime ", ylab = "Voltage")


## Bottom Left: Energy Sub Metering by Day
...
plot(wkday_h_power, as.numeric(subh_power$Global_reactive_power), type = "l",
